...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="date" class="form-control is-invalid " value="{{$employee->joining_date}}" id="joining_date" name="joining_date"
               placeholder="Y-m-d">
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <textarea class="form-control" rows="2" name="address" id="address" readonly>{{$employee->address}}</textarea>
    </div>
</div>
